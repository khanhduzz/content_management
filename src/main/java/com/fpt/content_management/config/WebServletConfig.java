package com.fpt.content_management.config;

import com.fpt.content_management.config.interceptor.MemberInterceptor;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"com.fpt.content_management"})
public class WebServletConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/auth/login").setViewName("member/login");
        registry.addViewController("/auth/register").setViewName("member/register");
        registry.addViewController("/contents/add").setViewName("member/add-content");
    }
